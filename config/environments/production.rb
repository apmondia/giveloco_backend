Rails.application.configure do
  ...
  # Full error business_reports are disabled and caching is turned on.
  ...
  config.action_controller.asset_host = "api.giveloco.com"
  ...
  Rails.application.routes.default_url_options[:host] = "api.giveloco.com"
