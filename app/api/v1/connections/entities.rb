module V1
	module Connections
		class Entities < Grape::Entity
			...
			expose :from_connection_id, :as => :from_user_id, :documentation => {:type => "integer", :desc => "The ID of the user who created the connection."}
	    	expose :to_connection_id, :as => :to_user_id, :documentation => {:type => "integer", :desc => "The ID of the user who accepted the connection."}
